...
# 🎮 Slayblade — Community Edition

**Standalone Community Edition of the action RPG Slayblade**
...
Slayblade is an action RPG set in a shattered realm where mastery of the blade decides the fate of kingdoms. This Community Edition is a self-contained package that includes all content and requires no additional software. No storefront is required, and the game is ready to play immediately after installation. LAN and direct connection multiplayer is supported.

This build is for players who want a complete, offline-ready standalone copy of Slayblade on Windows without a storefront account.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4117730/d1ae445cee0eab30ea89b59be0e9d847a5a16858/ss_d1ae445cee0eab30ea89b59be0e9d847a5a16858.1920x1080.jpg?t=1787260027" alt="Screenshot 1" width="100%"></td>
 ...
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4117730/840f7ee9643d5f168cbb6de878ec9b07c5e57e02/ss_840f7ee9643d5f168cbb6de878ec9b07c5e57e02.1920x1080.jpg?t=1787260027" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- **Interface:** English, German, French, Spanish, Japanese, Simplified Chinese
...
- ⚔️ **Skill-Based Sword Combat** — Parry, dodge, and combo system with dozens of unlockable blade techniques.
- 🌍 **Open World** — Explore a handcrafted realm of ruins, peaks, and hidden shrines at your own pace.
- 🔨 **Crafting & Forging** — Gather materials to forge and upgrade weapons, armor, and charms.
- 🤝 **Co-op Multiplayer** — LAN or direct connection supported for cooperative runs with up to four players.
- 🎯 **Boss Encounters** — Over 20 multi-phase boss fights with unique attack patterns.
- 🗺️ **Full Content Included** — Includes the base game and all expansion packs in one package.
- 💾 **Self-Contained Package** — No storefront or additional software required — ready to play immediately.
- 🌐 **Multi-Language Support** — Interface localized into six languages with English and Japanese voice acting.

- **Compression:** Lossless
- **Install Time:** ~5 minutes on SSD, ~12 minutes on HDD
- **Recoding:** none
- **Selective Download:** Base game and DLC can be installed together or separately during setup

---

## 📦 DLCs Included

- Slayblade: Ashen Peaks
- Slayblade: Crimson Court
- Slayblade: equipment pack
...
| **RAM** | 8 GB | 16 GB |
| **Graphics** | NVIDIA GeForce GTX 960 / AMD Radeon R9 280X, 4 GB VRAM | NVIDIA GeForce RTX 2060 / AMD Radeon RX 5700, 6 GB VRAM |
| **Storage** | 16 GB available space (HDD) | 16 GB available space (SSD) |
| **Additional** | DirectX 11 compatible sound card | DirectX 12 compatible sound card; controller recommended |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\Slayblade\Saved`
